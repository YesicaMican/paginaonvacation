...
import logoonvacation from "./logo1.png"
import background from "./fondo.jpg"

function App() {
  <body className='fondo' style={{ backgroundImage: `url(${background})` }}></body>
  const [showMessage, setShowMessage] = useState(false);
  return (
    <div className="divportada">
      <div>
        <img src={logoonvacation} className="img-fluid animacion" alt="logoonvacation"></img>
      </div>
