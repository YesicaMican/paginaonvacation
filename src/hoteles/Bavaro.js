...
function Bavaro() {
  ...
  return (
    ...
    <div className='justify'>
        <p >Siendo un hotel en Punta Cana de 5 estrellas con calidad e instalaciones de primer nivel, cuenta con 186 Tropical Deluxe, 124 Family Room. Todas completamente equipadas, perfectas para familias con niños gracias al completo servicio y amplitud de las habitaciones. Además, podrás disfrutar de Wi-Fi gratuito básico en todas las áreas del hotel </p>
        <div style={{ display: "flex" }}>
            <div id="carouselExample" className="carousel slide">
                <div className="carousel-inner">
                    <div className="carousel-item active" >
                        <img src="http://drive.google.com/uc?export=view&id=1cqORRDvRfMiUqhaYDaGVvVQtw29MC29w" className="img-fluid" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="http://drive.google.com/uc?export=view&id=173ipG8BGNaqdCsKIRDf9DxQzHKKaaVir" className="img-fluid" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="http://drive.google.com/uc?export=view&id=1T9AV2GigyrGCU17_6mg6F0aGLWPj07ET" className="img-fluid" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="http://drive.google.com/uc?export=view&id=1N13zemfoM14i3Ov2LCMvB1AwfTtD9yE6" className="img-fluid" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="http://drive.google.com/uc?export=view&id=1QH5uUvd_jmHZhwpPCi9Gwoz-6sV8R5iy" className="img-fluid" alt="..." />
                    </div>
                </div>
    ...
    <br />
    <iframe width="700" height="400" src="https://www.youtube.com/embed/xMRuO4XUiXs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen className='video'></iframe>
    <br />
    <br />
