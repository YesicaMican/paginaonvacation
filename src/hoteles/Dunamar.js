...
function Dunamar() {
  return (
    <div className="container">
      ...
      <div className="container">
        <p>
          Este hotel en Cancún - Costa Mujeres tiene un sinfín de servicios
          cuenta con una amplia oferta gastronómica, adicionalmente podrás
          disfrutar de los mejores programas de entretenimiento tanto diurnos
          como nocturnos, de música y shows en directo que harán que tus
            ...
            <div id="carouselExample" className="carousel slide ">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1RJ2DTtZvgnWyRdu4e9O-lyY4fZUyBhNg"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1iBq-5RD6W3CgvA2XRlcj4YaLgFnhrNqk"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1EfnZUdYCXLmj-knNOYl9h9BNqQKRtB97"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1AR0gNvA4MlLRAxWadHLy7vWiU8j5h7aI"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=15Q6fNTteSU3DRG5WILqLH3E8eOtQF1-P"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
      ...
      <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
        <iframe
          src="https://www.youtube.com/embed/nmD6ULdjzaw"
