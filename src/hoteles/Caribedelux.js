...
function Caribedelux() {
  ...
  return (
    <div className='justify'>
            ...
            <div className='justify'>
                <p >El hotel Caribe Deluxe Princess está situado en una de las más bellas playas de la República Dominicana, Playa Bávaro. Gracias a su ubicación, te permitirá disfrutar de un paraje donde la belleza de sus paisajes y el encanto de sus aguas cristalinas ofrecen una placentera sensación de paz y tranquilidad. Estarás a pie de playa y, además, a escasos 25 min del aeropuerto de Punta Cana</p>
                <div style={{ display: "flex" }}>
                    <div id="carouselExample" className="carousel slide">
                        <div className="carousel-inner">
                            <div className="carousel-item active" >
                                <img src="http://drive.google.com/uc?export=view&id=1R0HkUbAvMpI29LMP4Dtf3WvIcCmyGyOT" className="img-fluid" alt="..." />
                            </div>
                            <div className="carousel-item">
                                <img src="http://drive.google.com/uc?export=view&id=1hj_sKh66G8EPZPM--GuG_PTh7xqKdBkc" className="img-fluid" alt="..." />
                            </div>
                            <div className="carousel-item">
                                <img src="http://drive.google.com/uc?export=view&id=1QrhZZSh7OKp_JNk-TA80uqVX3REfj4oE" className="img-fluid" alt="..." />
                            </div>
                            <div className="carousel-item">
                                <img src="http://drive.google.com/uc?export=view&id=1hDzoj6SW3AnpAAXdAvzswotAIQZw369S" className="img-fluid" alt="..." />
                            </div>
                            <div className="carousel-item">
                                <img src="http://drive.google.com/uc?export=view&id=1bizjcHcf-umz3nFLLpOU6Y_vPzrN3JX9" className="img-fluid" alt="..." />
                            </div>
                        </div>
            ...
            <br />
            <iframe width="700" height="400" src="https://www.youtube.com/embed/IPLgwEUCw7Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen className='video'></iframe>
            <br />
            <br />
