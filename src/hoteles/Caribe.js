...
function Caribe() {
  return (
    <div className="container">
      ...
      <div className="container">
        <p>
          Este lujoso Hotel de elegante arquitectura colonial, es uno de los
          alojamientos más emblemáticos de la ciudad y considerado uno de los
          monumentos nacionales de Cartagena, está ubicado en Bocagrande.
        </p>
            ...
            <div id="carouselExample" className="carousel slide ">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img
                    src="http://drive.google.com/uc?export=view&id=16g9COJgo3C8G2PTj0pCmrTdcLiXe3mh2"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1PJVPxzpRnwScdFor-xtzPdR8Q-2ImQNv"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1snmVbhRXMZBws257TbPuv_4OUdKociV0"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1Ep2dzTVmdd6XeI_rJT82PVXoz0K1fSah"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1iZLxxuiJnMcJXpZzXA3OOf-9Q25ISzFu"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
      ...
      <div className="row">
        <div className="col-lg-6 reco">
          ...
          <p>
            ...
            privado, closet, cajilla de seguridad, amenities en el baño y
            escritorio.
          </p>
          <h1 className="title">
          ...
          <p>
            {" "}
            Puedes disfrutar de la pisicina, el spa, salón de juegos, los
            jardines o puedes disfrutar de la playa ya que el hotel cuenta con
            acceso directo.{" "}
          </p>
        </div>
        <div className="col-lg-6 reco">
          ...
          <p>
            Cafetería India Catalina: Ofrece cafés, bebidas refrescantes y
            comidas ligeras. Horario: 6:30 am a 10:30 pm.
            <br />
