...
function Nyx() {
  return (
    <div className="container">
      ...
      <div className="container">
        <p>
          Descubre y sumérjete en la verdadera esencia de Cancún, México, y
          disfruta de cada momento! Su ubicación, su diseño, así como su amplia
          gama de servicios y actividades para todas las edades, convierten al
          Hotel NYX Cancún en un resort perfecto donde familias, parejas o
          grupos de amigos pueden disfrutar de unos inolvidables y merecidos
          días de descanso.
        </p>
          ...
          <div className="col-md-7">
            <div id="carouselExample" className="carousel slide ">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1pUawsuuA-hgeiqA7t0xRCR2j6HZZdEds"
                    className="img-fluid"
                    alt="..."
                  />
>>>>>>> 6ac2ff0d988dd1a6c826457d56889126d4b8ae37
                ...
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1m4IxEOhlOmz6-eJfNO_6T5tPsF6-0Bts"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
...
=======
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1JN1-K3CR9mc7L6rikFl5X7utZkcp2ULO"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1KBzRqckhw633Gb3u_3Ib2ObgXww7PVUh"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
                <div className="carousel-item">
                  <img
                    src="http://drive.google.com/uc?export=view&id=1Mc32DqwwbkWWft9tHyVbi090Oj32uUe-"
                    className="img-fluid"
                    alt="..."
                  />
                </div>
...
=======
      ...
      <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
        <iframe
          src="https://www.youtube.com/embed/6p3q5gZRwig"
      ...
      <div className="row">
        <div className="col-lg-6 reco">
          ...
          <p>
            El hotel Riu Dunamar se encuentra ubicado al borde de una
            paradisíaca playa en Costa Mujeres, Quintana Roo, a unos 30
